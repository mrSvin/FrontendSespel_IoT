...
function panel_admin(back_color, border_color) {
    ...
    $('#table_users tr').attr("style", 'outline: 1px solid' + border_color +'!important; border-color:' + border_color +';position: sticky; width: 100%; margin-top: 90px; top: 75px; z-index: 1;');
