...
function hightcharts_colors(back_color, text_color, calen_1_color, calen_3_color, legend_color, line_special)
{
    ...
    $( "path[aria-label*='Заданное давление, т, series 2 of 2. Line with 102 data points.']" ).attr( 'style', `stroke: red!important;` ); // отдельный цвет линии в графиках
    $( "path[aria-label*='Температура, С, series 2 of 2. Line with 12 data points.']" ).attr( 'style', `stroke: red!important;` ); // для спец. комплексов.
}
