...
Highcharts.chart('container_days3', {
    ...
    series: [{
        ...
        data: [ntx1000_avar_day[0], ntx1000_avar_day[1], ntx1000_avar_day[2],ntx1000_avar_day[3],ntx1000_avar_day[4],ntx1000_avar_day[5],ntx1000_avar_day[6],ntx1000_avar_day[7],ntx1000_avar_day[8],ntx1000_avar_day[9],ntx1000_avar_day[10],ntx1000_avar_day[11],
            ...
            ntx1000_avar_day[24],ntx1000_avar_day[25],ntx1000_avar_day[26],ntx1000_avar_day[27],ntx1000_avar_day[28],ntx1000_avar_day[29],ntx1000_avar_day[30]]
    }, {
        name: 'Выключен',
...
Highcharts.chart('container3', {
    ...
    series : [ {
        type : 'pie',
        name : 'Показатель',
        data : [ [ 'По программе', ntx1000_work ], [ 'Включен', ntx1000_pass ], [ 'Выключен', ntx1000_fail],  [ 'В аварии', ntx1000_avar ], [ 'Под нагрузкой', ntx1000_nagruzka ]  ]
    }]
});