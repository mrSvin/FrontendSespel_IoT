function RezkaMonth() {
    ...
    useEffect(() => {
        ...
        let roundKim = fetchHighCharts('navigator_1', `${yearNow}-${monthNow}`, 1)
        let roundNK600 = fetchHighCharts('navigator_2_golova_2', `${yearNow}-${monthNow}`, 2)
        let roundStp13m = fetchHighCharts('navigator_3', `${yearNow}-${monthNow}`, 3)
        let roundComplex4 = fetchHighCharts('trulaser', `${yearNow}-${monthNow}`, 4)
        let roundComplex5 = fetchHighCharts('kometa_1', `${yearNow}-${monthNow}`, 5)
        let roundComplex6 = fetchHighCharts('kometa_2', `${yearNow}-${monthNow}`, 6)
        let roundComplex7 = fetchHighCharts('kometa_3', `${yearNow}-${monthNow}`, 7)
    ...
    function updateData() {
        if (dateMonth != "0") {
            ...
            let roundKim = fetchHighCharts('navigator_1', dateMonth, 1)
            let roundNK600 = fetchHighCharts('navigator_2_golova_2', dateMonth, 2)
            let roundStp13m = fetchHighCharts('navigator_3', dateMonth, 3)
            let roundComplex4 = fetchHighCharts('trulaser', dateMonth, 4)
            let roundComplex5 = fetchHighCharts('kometa_1', dateMonth, 5)
            let roundComplex6 = fetchHighCharts('kometa_2', dateMonth, 6)
            let roundComplex7 = fetchHighCharts('kometa_3', dateMonth, 7)
