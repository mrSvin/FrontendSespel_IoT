...
function Photo({heightHighchartContainer, photoArray, loading}) {
    ...
    let style = {
        height: getLunchHeight(heightHighchartContainer)/heightHighchartContainer,
        width: getLunchHeight(heightHighchartContainer)/heightHighchartContainer
    }
                ...
                {photoArray.map((e, i) => {
                    return (
                        <div key={i} className='otklonTime' style={style}>
                            <img className='skudAvatar' style={style} src={`data:image/jpeg;base64,${e == undefined ? undefImg : e}`}
                                 alt=""/>
                        </div>)
                })
                }
