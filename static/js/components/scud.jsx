        ...
        promise.then(data => {
            ...
            if (!Object.keys(data).includes('error')) {
                ...
                imagePromise.then(e => {
                    ...
                    let testLen = document.getElementsByClassName('highcharts-axis-labels highcharts-yaxis-labels')[1].querySelectorAll('span').length
                    console.log('Состояние - ', testLen, 'Число фоток - ', arrayPhotos.length)
                    if(arrayPhotos.length == heightHighchartContainer){
