function RezkaInfo() {
    ...
    useEffect(() => {
        ...
        let roundKim = fetchRequest(`${yearNow}-${monthNow}-${dayNow}`, kimData, 'navigator_1', 1)
        let roundNK600 = fetchRequest(`${yearNow}-${monthNow}-${dayNow}`, nk600Data, 'navigator_2_golova_2', 2)
        let roundStp13m = fetchRequest(`${yearNow}-${monthNow}-${dayNow}`, stp13m, 'navigator_3', 3)
        let roundRtc12c = fetchRequest(`${yearNow}-${monthNow}-${dayNow}`, rtk12c, 'trulaser', 4)
        let roundP250 = fetchRequest(`${yearNow}-${monthNow}-${dayNow}`, p250, 'kometa_1', 5)
        let roundKrot = fetchRequest(`${yearNow}-${monthNow}-${dayNow}`, krot, 'kometa_2', 6)
        let roundPrans = fetchRequest(`${yearNow}-${monthNow}-${dayNow}`, prans, 'kometa_3', 7)
    ...
    function newDate(dateInput) {
        ...
        let roundKim = fetchRequest(`${dateInput}`, kimData, 'navigator_1', 1)
        let roundNK600 = fetchRequest(`${dateInput}`, nk600Data, 'navigator_2_golova_2', 2)
        let roundStp13m = fetchRequest(`${dateInput}`, stp13m, 'navigator_3', 3)
        let roundRtc12c = fetchRequest(`${dateInput}`, rtk12c, 'trulaser', 4)
        let roundP250 = fetchRequest(`${dateInput}`, p250, 'kometa_1', 5)
        let roundKrot = fetchRequest(`${dateInput}`, krot, 'kometa_2', 6)
        let roundPrans = fetchRequest(`${dateInput}`, prans, 'kometa_3', 7)
